...
export default function ReportabilidadPage() {
  return (
    <main>
      <PageHero eyebrow="Reportabilidad tecnica" title={service.title} description={service.summary} />
